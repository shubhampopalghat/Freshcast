  ...
  if (!hasNearbyCities) {
    return (
      <div className=" animate-pulse">
        <h2 className="tracking-tighter font-medium text-2xl mb-2">Other Cities</h2>
    ...
    <div className="animate-fade-in ">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        {nearbyCities.slice(0, 4).map((city, index) => (
          <div 
            key={index} 
            className="h-[90%] bg-card-bg rounded-3xl p-4 cursor-pointer transition-transform hover:scale-[1.02]"
